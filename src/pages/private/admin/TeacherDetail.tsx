      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card
            ...
            description="Career details and employment information"
          >
            <div className="px-8 py-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
          ...
          {teacherData.assignedClasses && teacherData.assignedClasses.length > 0 && (
            <Card
              title={`Assigned Classes (${teacherData.assignedClasses.length})`}
              description="Classes and subjects assigned to this teacher"
            >
              <div className="px-8 py-6">
                <div className="space-y-4">
          ...
          {teacherData.levels && teacherData.levels.length > 0 && (
            <Card
              title={`Teaching Levels (${teacherData.levels.length})`}
              description="Academic levels and their configurations"
            >
              <div className="px-8 py-6">
                <div className="space-y-4">
