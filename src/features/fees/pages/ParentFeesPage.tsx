    ...
    <div className="space-y-6">
      ...
      {feesError ? (
        ...
        <EmptyState
          ...
          description="Please select a student to view their fees"
        />
      ) : fees.length > 0 ? (
        <>
          {/* Statistics */}
        ...
        <EmptyState
          icon={DollarSign}
          title="No fees found"
          description="No fees records found for the selected student and filters"
        />
      )}
    </div>
  );
