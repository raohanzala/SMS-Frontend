...
interface TeacherAttendanceStatusSelectorProps {
  currentStatus: TeacherAttendanceStatus;
  onStatusChange: (status: TeacherAttendanceStatus) => void;
  disabled?: boolean;
}

const TeacherAttendanceStatusSelector = ({
  currentStatus,
  onStatusChange,
  disabled = false,
}: TeacherAttendanceStatusSelectorProps) => {
  const statusOptions: {
...
export default TeacherAttendanceStatusSelector;
